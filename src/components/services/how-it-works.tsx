      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-muted-foreground">
            Prodigy systems activate to create a humidity bubble around your
            property, built to reduce ignition risk before wildfire conditions
          ...
          <div className="flex flex-col gap-10 text-center">
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                ...
                stable moisture zone that surrounds roofs, walls, eaves, and
                vulnerable openings. The result is a temporary, precisely
                engineered shield that prepares your property before wildfire
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                ...
                areas such as roofs, vents, and decks, preventing embers from
                landing, smouldering, or taking hold. By reducing heat, raising
                moisture, and stabilising structural surfaces, the humidity
                bubble creates an active, science-driven defence long before
