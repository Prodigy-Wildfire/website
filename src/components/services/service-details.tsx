...
const services = [
  ...
  },
  {
    ...
    description:
      "Prodigy's next-generation ember and flame detection sensors give property owners across the USA, Canada, and Australia an early-warning advantage against wildfire threats. With 360-degree perimeter scanning, our weather-resistant sensors continuously monitor for airborne embers and flame activity  - detecting ignition risks long before they reach your structure. Integrated with the Prodigy app, alerts are delivered instantly to your device so you can activate your wildfire sprinkler system in seconds. Engineered to withstand extreme heat, wind, and harsh conditions, our detection technology provides reliable, round-the-clock wildfire monitoring for homes, businesses, and critical infrastructure in high-risk fire zones.",
    reverse: false,
  },
];
