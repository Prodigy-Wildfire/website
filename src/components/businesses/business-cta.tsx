    ...
    <section className="bg-primary py-20 md:py-28">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <h2 className="font-heading text-3xl font-bold tracking-tight text-primary-foreground md:text-4xl">
          Ready to <span className="text-accent">Protect</span> Your Business?
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-primary-foreground/70">
          Request a free commercial property assessment and our team will survey
          your site, design a custom wildfire protection system, and provide a
          detailed quote. From assessment to installation, we handle every step.
        </p>
