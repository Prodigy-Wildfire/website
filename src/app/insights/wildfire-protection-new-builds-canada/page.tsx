...
const jsonLd = {
  ...
  mainEntityOfPage: "https://www.prodigywildfire.com/insights/wildfire-protection-new-builds-canada",
};
    ...
    <>
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Wildfire Protection for New Developments in Canada: A Builder's Guide" },
        ]}
      />
      <Header />
      <main>
        ...
        <ArticleAuthor date="4 March 2026" />
