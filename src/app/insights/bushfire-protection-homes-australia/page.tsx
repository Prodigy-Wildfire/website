...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/insights/bushfire-protection-homes-australia" },
  openGraph: {
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: "https://www.prodigywildfire.com/insights/bushfire-protection-homes-australia",
};
    ...
    <>
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Is Your Home Ready for Bushfire Season? A Practical Guide to Protecting Your Property" },
        ]}
      />
      <Header />
      <main>
        ...
        <ArticleAuthor date="23 February 2026" />
